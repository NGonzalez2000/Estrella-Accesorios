...
Public Class Frm_Etiqueta
    ...
    Sub Buscar_Registros()
        Dim SQL = "SELECT Count(Etiquetas.art_id) AS cant, Etiquetas.art_id, Articulos.art_codigo_barras, Articulos.art_descripcion, Articulos.art_importe_venta
                   FROM Articulos INNER JOIN Etiquetas ON Articulos.art_id = Etiquetas.art_id
                   GROUP BY Etiquetas.art_id, Articulos.art_codigo_barras, Articulos.art_descripcion, Articulos.art_importe_venta
                   ORDER BY Etiquetas.art_id;"
        ...
        If Base.Ejecutar_SQL(SQL, Tabla) Then
            ...
            Do While Tabla.Read
                ...
                Itm.SubItems.Add(Format(Tabla.Item("art_importe_venta"), "$ ##,##0.00"))
                Itm.Checked = True
            ...
            End If
        Else
            MsgBox("Se produjo un error al leer los códigos de las etiquetas")
        End If
    End Sub

    Private Sub Frm_Etiqueta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub D_Codigo_TextChanged(sender As Object, e As EventArgs) Handles D_Codigo.TextChanged
        ...
        D_Precio.Text = Format(0, "$ ##,##0.00")
        D_Descripcion.Text = ""
    End Sub

    Private Sub Frm_Etiqueta_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Frm_Etiqueta_Shown(sender As Object, e As EventArgs) Handles Me.Shown
    ...
    Private Sub D_Codigo_Validating(sender As Object, e As CancelEventArgs) Handles D_Codigo.Validating
        ...
        If D_Codigo.Text <> "" Then
            ...
            Sql = "SELECT art_id, art_descripcion, art_importe_venta FROM Articulos WHERE art_codigo = '" + D_Codigo.Text + "' OR art_codigo_barras = '" + D_Codigo.Text + "'"
            If Base.Ejecutar_SQL(Sql, Tabla) Then
                If Tabla.Read() Then
                    ...
                    D_Precio.Text = Format(Tabla.Item("art_importe_venta"), "$ ##,##0.00")
    ...
    Private Sub Borrar_Click(sender As Object, e As EventArgs) Handles Borrar.Click
        If MsgBox("¿Esta seguro que desea borrar todas las etiqutas seleccionadas?", vbQuestion + vbYesNo + vbDefaultButton2) = vbYes Then
            ...
            Else
                ...
                Sql = "DELETE * FROM Etiquetas WHERE art_id IN (" + Sql + ")"
            End If
    ...
    Private Sub Aceptar_Articulo_Click(sender As Object, e As EventArgs) Handles Aceptar_Articulo.Click
        Dim Sql As String = "INSERT INTO Etiquetas (art_id) VALUES (" + D_Codigo.Tag.ToString + ")"

        For I As Integer = 1 To D_Cantidad.Tag
            If Not Base.Ejecutar_SQL(Sql) Then
                MsgBox("Se produjo un error al intentar cargar las Etiquetas de las etiquetas")
                Exit For
            End If
        Next
        Cancelar_Articulo.PerformClick()
    ...
    Private Sub Imprimir_Click(sender As Object, e As EventArgs) Handles Imprimir.Click
        ...
        For Each Itm As ListViewItem In Listado.CheckedItems
            ...
            Dim Img As Image = QQR.Generar_QR(Codigo, 2) ', Color.Black, Color.White, Application.StartupPath + "\Imagenes\Estrella.ico")
            Img.Save(Arch)
            Dim Sql1 = "UPDATE Etiquetas SET etq_ruta = '" + Arch + "' WHERE art_id = " + Itm.Tag.ToString
        ...
        If D_Etiqueta.Checked Then
            Dim Reporte As New Rpt_EtiquetasEstanteria
        ...
        Else
            Dim Reporte As New Rpt_EtiquetasEstanteria1
    ...
    Private Sub Buscar_Click(sender As Object, e As EventArgs) Handles Buscar.Click
        ...
        Frm_Art.Origen = Origen.F_Etiqueta
        ...
        Try
            If Listado.SelectedItems.Count = 1 Then
                ...
                If (Aux > 0) And (Aux <= CInt(Listado.SelectedItems(0).Text)) Then
                    Dim SQL As String = "DELETE * FROM (SELECT TOP " + Aux.ToString + " * FROM Etiquetas WHERE Etiquetas.art_id=" + Listado.SelectedItems(0).Tag.ToString + ") AS deletes;"
