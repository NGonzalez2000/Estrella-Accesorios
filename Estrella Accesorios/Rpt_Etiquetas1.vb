...
Public Class Rpt_Etiquetas1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Estrella_Accesorios.Rpt_Etiquetas1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Etiquetas1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Etiquetas1 = New Rpt_Etiquetas1()
        rpt.Site = Me.Site
        Return rpt
    End Function
