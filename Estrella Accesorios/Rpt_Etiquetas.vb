...
Public Class Rpt_Etiquetas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Estrella_Accesorios.Rpt_Etiquetas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Etiquetas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Etiquetas = New Rpt_Etiquetas()
        rpt.Site = Me.Site
        Return rpt
    End Function
